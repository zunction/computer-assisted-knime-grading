...
|  13 | node_count                                             | Total number of nodes found in the workflow. The node might not be connected, executed and purely just exists in the workflow.                                                                       |    int   |         |                                | The filepaths which the data is loaded from using CSV Table Reader, Excel Table Reader or File Reader node.                                                                                                                                                   |          |         |  
